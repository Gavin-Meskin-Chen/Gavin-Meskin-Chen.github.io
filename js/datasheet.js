...
const u1 = 'https://cdn.cbd.int/cansin-music-jackyxue1@1.0.0';
const u2 = 'https://cdn.cbd.int/cansin-music-jackyxue2@1.0.0';
const u1a = u1 + '/audio/';
const u1c = u1 + '/cover/';
const u1l = u1 + '/lrc/';
const u2a = u2 + '/audio/';
...
var QianSongsheet = [
    {
        ...
        title: "那是你离开了北京的生活",
        author: "薛之谦",
        url: u1a + "那是你离开了北京的生活.mp3",
        pic: u1c + "那是你离开了北京的生活.jpg",
        lrc: u1l + "那是你离开了北京的生活.lrc"
    }, {
        title: "花儿和少年",
        author: "薛之谦",
        url: u1a + "花儿和少年.mp3",
        ...
        title: "我好像在哪见过你",
        author: "薛之谦",
        url: u1a + "我好像在哪见过你.mp3",
        pic: u1c + "我好像在哪见过你.jpg",
        lrc: u1l + "我好像在哪见过你.lrc"
    }, {
        title: "丑八怪",
        author: "薛之谦",
        url: u1a + "丑八怪.mp3",
